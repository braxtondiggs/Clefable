...
<?php switch ($assets){
	...
	<!-- date picker css -->
	<link rel="stylesheet" href="<?=base_url('css/app/datepicker.css?v=1')?>">
	<!-- full calander css -->
	<link rel="stylesheet" href="<?=base_url('css/app/fullcalendar.css?v=1')?>">
	<!-- data tables extended CSS -->
	<link rel="stylesheet" href="<?=base_url('css/app/TableTools.css?v=1')?>">
	<!-- bootstrap wysimhtml5 editor -->
	<link rel="stylesheet" href="<?=base_url('css/app/bootstrap-wysihtml5.css?v=1')?>">
	<link rel="stylesheet" href="<?=base_url('css/app/wysiwyg-color.css')?>">
	<!-- custom/responsive growl messages -->
	<link rel="stylesheet" href="<?=base_url('css/app/toastr.custom.css?v=1')?>">
	<link rel="stylesheet" href="<?=base_url('css/app/toastr-responsive.css?v=1')?>">
	<link rel="stylesheet" href="<?=base_url('css/app/jquery.jgrowl.css?v=1')?>">
	
	<!-- // DO NOT REMOVE OR CHANGE ORDER OF THE FOLLOWING // -->
	<!-- bootstrap default css (DO NOT REMOVE) -->
	<link rel="stylesheet" href="<?=base_url('css/app/bootstrap.min.css?v=1')?>">
	<link rel="stylesheet" href="<?=base_url('css/app/bootstrap-responsive.min.css?v=1')?>">
	<!-- font awsome and custom icons -->
	<link rel="stylesheet" href="<?=base_url('css/app/font-awesome.min.css?v=1')?>">
	<link rel="stylesheet" href="<?=base_url('css/app/cus-icons.css?v=1')?>">
	<!-- jarvis widget css -->
	<link rel="stylesheet" href="<?=base_url('css/app/jarvis-widgets.css?v=1')?>">
	<!-- Data tables, normal tables and responsive tables css -->
	<link rel="stylesheet" href="<?=base_url('css/app/DT_bootstrap.css?v=1')?>">
	<link rel="stylesheet" href="<?=base_url('css/app/responsive-tables.css?v=1')?>">
	<!-- used where radio, select and form elements are used -->
	<link rel="stylesheet" href="<?=base_url('css/app/uniform.default.css?v=1')?>">
	<link rel="stylesheet" href="<?=base_url('css/app/select2.css?v=1')?>">
	<!-- main theme files -->
	<link rel="stylesheet" href="<?=base_url('css/app/theme.css?v=1')?>">
    ...
    <link rel="stylesheet" id="switch-width" href="<?=base_url('css/app/full-width.css?v=1')?>">
    ...
    <!--[if lt IE 9]>
   		...
   		<script src="<?=base_url('js/app/include/respond.min.js')?>"></script>
   	<![endif]-->
	...
	<!-- For retina screens -->
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?=base_url('images/favicons/apple-touch-icon-retina.png')?>">
	<!-- For iPad 1-->
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="i<?=base_url('mages/favicons/apple-touch-icon-ipad.png')?>">
	<!-- For iPhone 3G, iPod Touch and Android -->
	<link rel="apple-touch-icon-precomposed" href="<?=base_url('images/favicons/apple-touch-icon.png')?>">
